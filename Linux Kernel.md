...
```bash
sudo apt-get install git fakeroot build-essential ncurses-dev xz-utils libssl-dev bc flex libelf-dev bison gdb gcc git-email gpg nftables make mutt tcpdump tor vim gawk coccinelle sparse clang-format
```
